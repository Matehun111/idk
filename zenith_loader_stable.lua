-- ======================================================================
--  ZENITH | STABLE | Cloud Loader  v2.0.0
...
local TIER       = "stable"
local AUTH_VER   = 2
local DB_KEYS    = "zenith_stable_keys_v2"
local DB_USERS   = "zenith_stable_users_v2"
local DB_SESSION = "zenith_stable_session_v2"
...
local function do_register(key, name, pw)
    ...
    if not VALID_KEYS[key] then
        set_status(255,60,60,"Invalid key. Check prefix: ZNTST-XXXX-XXXX"); return
    end
...
local btn_register = grp_aa:button('Register', nil, true)
local btn_login    = grp_aa:button('Login',    nil, true)
local btn_logout   = grp_aa:button('Logout',   nil, true)
...
grp_oth:label('\f<dot>\ac8c8c8ff   (ZNTST-XXXX-XXXX)')
