...
-- ── HELPERS ───────────────────────────────────────────────────────────
local function clog(r,g,b,m) client.color_log(r,g,b,"[zenith.gs STABLE] "..tostring(m)) end
...
grp_fl:label('\f<dot>\ac8c8c8ffSTABLE  —  Authentication'):depend(_vis)
...
local fl_tier   = grp_fl:label('\f<dot>Tier:   \ac8c8c8ffSTABLE'):depend(_vis)
grp_fl:label(' '):depend(_vis)
...
grp_oth:label('\f<dot>\ac8c8c8ff   (ZNTST-XXXX-XXXX)'):depend(_vis)
