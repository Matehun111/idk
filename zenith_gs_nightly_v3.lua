-- ======================================================================
--  ZENITH | NIGHTLY | Cloud Loader  v3.0.0
...
local TIER       = "nightly"
local AUTH_VER   = 3
local DB_SESSION = "zenith_nightly_session_v3"
...
local fl_tier   = grp_fl:label("\f<dot>Tier:   \a4799ffffNIGHTLY"):depend(_vis)
grp_fl:label(" "):depend(_vis)
...
grp_oth:label("\f<dot>\ac8c8c8ff   (ZEN-NIGHTLY-...)"):depend(_vis)
